...
const questions = [
  {
    ...
    type: 'select',
    icon: '🎯',
    options: ['Prepare for a race', 'Start running', 'Weight loss & fitness', 'Improve my performance']
  },
  {
    id: 'prepareRace',
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen w-full max-w-[375px] mx-auto flex flex-col" 
         style={{
      ...
      >
        ...
        {/* Question Options */}
        {isWaitingForAnswer && currentQuestion && currentQuestion.type === 'select' && (
        ...
        {/* Date Input */}
        {isWaitingForAnswer && currentQuestion && currentQuestion.type === 'date' && (
        ...
        {/* Completion Message */}
        {currentQuestion && currentQuestion.type === 'complete' && !isWaitingForAnswer && (
          <div className="text-center py-4">
            <p className="text-[#E9ED0E] text-lg font-medium" style={{ fontFamily: 'Inter, sans-serif' }}>
